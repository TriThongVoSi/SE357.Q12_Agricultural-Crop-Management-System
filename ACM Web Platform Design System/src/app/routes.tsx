  ...
  return (
    <Routes>
      ...
      >
        ...
        {/* Alternative simpler pages using new backend endpoints */}
        {/* Uncomment to use simpler versions:
        <Route path="seasons-simple" element={<SeasonsPage />} />
        <Route path="tasks-simple" element={<TasksWorkspacePage />} />
        */}
      </Route>
