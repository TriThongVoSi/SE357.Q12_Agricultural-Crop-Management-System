            ...
            <header className="supplies-header">
                <div className="header-content">
                    <div className="header-title">
                        ...
                        <div>
                            <h1 className="font-bold">Suppliers & Supplies</h1>
                            <p className="subtitle">Manage suppliers and supply items</p>
                        </div>
                    </div>
                    <button
                ...
                <tbody>
                    {data.map((lot) => (
                        <tr key={lot.id}>
                            ...
                            <td className={isExpiringSoon(lot.expiryDate) ? 'expiring-soon' : ''}>
