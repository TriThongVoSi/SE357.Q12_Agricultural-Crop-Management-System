...
import { FileText, Plus, Loader2, Search, Calendar, Filter, Trash2, Pencil, AlertCircle } from 'lucide-react';
                    ...
                    {seasonsLoading ? (
                        ...
                        <div className="flex flex-wrap items-center gap-4">
                            ...
                            <Select value={typeFilter} onValueChange={setTypeFilter}>
                                <SelectTrigger className="w-full md:w-48" disabled={!selectedSeasonId}>
